document.addEventListener('DOMContentLoaded', () => {
    ...
    menu.innerHTML = `
        ...
        <div class="menu-content">
            <div class="menu-content-inner">
                ...
                <div class="menu-row pattern-toggle">
                    <div class="menu-label">PATTERN_OVERLAY</div>
                    <div class="toggle-group">
                        <button class="toggle-btn" data-pattern="true">ON</button>
                        <button class="toggle-btn" data-pattern="false">OFF</button>
                    </div>
                </div>
    ...
    menu.querySelectorAll('.pattern-toggle .toggle-btn').forEach(btn => {
        if (btn.dataset.pattern === String(patternEnabled)) btn.classList.add('active');
        btn.addEventListener('click', () => {
            menu.querySelectorAll('.pattern-toggle .toggle-btn').forEach(b => b.classList.remove('active'));
            btn.classList.add('active');
            patternEnabled = btn.dataset.pattern === 'true';
    ...
    function applyPattern() {
        if (window.PatternRenderer) {
            window.PatternRenderer.setVisible(patternEnabled);
        }
    }
